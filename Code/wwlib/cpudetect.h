...
public:
    ...
    inline static unsigned long long Get_Processor_Ticks_Per_Second() { return ProcessorTicksPerSecond; }	// Ticks per second
...
//	static void Detect_CPU_Type();
    ...
    static unsigned long long ProcessorTicksPerSecond;	// Ticks per second
